...
class AsyncRoadDetector:
    ...
    def __init__(self, roi_height: int = 80):
        """
        初始化道路检测器
...
async def main_example():
    ...
    try:
        async for result in detector.process_frames_stream(frame_provider.frames_generator(),callback=process_callback,interval=0.2):
            print(result)
